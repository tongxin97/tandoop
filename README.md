...
mvn compile assembly:single && java -cp ../commons-cli/target/commons-cli-1.5-SNAPSHOT.jar:target/tandoop-1.0-SNAPSHOT-jar-with-dependencies.jar -Xbootclasspath/a:jacocoagent.jar -javaagent:jacocoagent.jar com.github.tongxin97.tandoop.Main -src ../commons-cli/src/main/java -prj ../commons-cli -limit 900 -numTests 500
